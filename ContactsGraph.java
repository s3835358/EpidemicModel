...
public interface ContactsGraph
{
	...
	/**
	 * Returns the current SIRState of a vertex.
	 * 
	 * @param vertLabel Vertex to find the state of.
	 * 
	 * @returns The SIRState associated with vertLabel.
	 */
	public abstract SIRState getState(String vertLabel);
	
	/**
	 * Returns a string array of all vertices in a graph
	 * 
	 * @returns A String[] containing all vertices within the graph.
	 */
	public abstract StrArray getVertices();
